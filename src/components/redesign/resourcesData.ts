...
export const RESOURCES: Record<string, ResourceItem> = {
  ...
  "how-to-get-cleaning-contracts": {
    ...
    body: [
      ...
      { type: "p", text: "BidNet Direct, GovernmentBids.com, GovWin and similar services pull solicitations from many sources into one feed. BidNet Direct alone carries a network of around 1,300 local government departments uploading bid documents directly." },
      ...
      { type: "list", ordered: true, items: [
        { lead: "Get a Unique Entity ID on SAM.gov.", text: "You cannot bid on federal facility work without one." },
        { lead: "Register the right NAICS codes.", text: "Janitorial services is 561720. Add 561790 for specialized cleaning such as windows, carpet and upholstery, and 561730 for landscaping and grounds where a facility contract bundles them. If you are not registered for the code on a solicitation, it may not surface in your searches, and agencies researching contractors will not find you." },
        { lead: "Verify as a small business.", text: "The federal government sets a goal of awarding 23% of all contracts to small businesses, and only firms verified as small on SAM are eligible for those set-asides. Janitorial is one of the more accessible categories under that goal." },
      ...
      { type: "p", text: "**Calculate labor from a production rate.** Production rate is how many square feet one cleaner covers per hour for a given task, and it is the number that decides whether the bid is profitable. The ISSA 612 cleaning times standard is the industry benchmark. Published general-office figures vary by source, roughly 2,500 to 4,200 square feet per hour, and medical space runs far slower at around 2,200. That spread is the point: use your own measured rate, and break the building into area types rather than applying one rate to the whole floor." },
...

      {
        ...
        body: "Two parts. Part one is a pricing worksheet you keep: production rates by area type, fully loaded labor rate, the costs most bids forget, and a margin formula you cannot get wrong. Part two is the bid document you send, with scope, exclusions, insurance, references and a follow-up schedule. Free, both files, no card.",
