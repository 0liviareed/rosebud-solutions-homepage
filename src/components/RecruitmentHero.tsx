...
// Rosebud Solutions — Recruitment hero (animated workflow, v2).
// Sliding/filling tab line drives auto-advance (onAnimationEnd keeps the
// ticker and stage in sync; hover pauses both). Connector paths are measured
// from the cards' real positions. Adapted to the design system: existing
// fonts (--font-cormorant / --font-dm-sans), the site page background
// (transparent here), system purple, and the shared glow CTA (BookDemoCTA)
// for the primary "Get started" action.
