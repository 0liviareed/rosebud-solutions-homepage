...
// Rosebud Solutions — Dental, Aesthetic & Private Healthcare hero.
// Same template as RecruitmentHero / InsuranceHero, content swapped to the
// practice front desk. Sliding/filling tab line drives auto-advance; connector
// paths measured from real card positions (horizontal fan-in on desktop,
// vertical thread when stacked on mobile). Design-system layer: Cormorant /
// DM Sans, transparent over the page background, system purple, glow
// BookDemoCTA. Anything clinical escalates to a clinician.
...
const STAGES: Stage[] = [
  ...
  },
  {
    tab: "Scheduling",
    inputs: [
      { label: "Live diary", detail: "Dentally, SOE, Pabau" },
      { label: "Practitioner availability", detail: "Across the whole team" },
  ...
  },
  {
    tab: "Recall",
    inputs: [
      { label: "Recall by treatment", detail: "Hygiene, top-ups, ortho reviews" },
      { label: "Aftercare sequences", detail: "Triggered by the appointment" },
      { label: "Lapsed patients", detail: "The ones you assumed left" },
    ],
    output: {
      chip: "Recall worked",
      q: "Who's due back that you'd have lost?",
      a: "Recall diarised by treatment type and worked automatically, aftercare sequenced from the visit. The patients you assumed went elsewhere, back in your diary.",
      metric: { value: "2–3 hrs / day", label: "admin back to each receptionist" },
    },
  },
];
    ...
    <section className="rbh">
      ...
      <div className="rbh-eyebrow">
        ...
        <span className="rbh-loc">
          <i>III</i> For Dental, Aesthetic &amp; Private Healthcare
        </span>
      </div>

      <h1 className="rbh-h1">
        Your clinicians, <em>back to the chair.</em>
      </h1>
      ...
      <div
        className="rbw-tabs"
        role="tablist"
        aria-label="Patient workflow stages"
        onMouseEnter={hold}
