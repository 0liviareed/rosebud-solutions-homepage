...
export const metadata: Metadata = {
  ...
  description:
    "Apply for the Account Executive role at Rosebud Solutions — remote, commission-only, full-cycle closing, no base salary.",
    ...
    <main className="rb-job rb-apply-page">
      <header className="rb-job-header rb-apply-page-header">
        <div className="rb-apply-page-container">
          <Link href="/careers/ae" className="rb-apply-page-back">
